        ...
        <header class="p-4 border-b bg-nav-bg border-nav-border sticky top-0 z-40 backdrop-blur-md shadow-header">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2.5">
                   <img src="/img/logo.png" alt="Logo" class="w-8 h-8 bg-primary p-1 rounded-lg">
                   <h1 class="text-xl font-semibold text-inherit">FlickToolz</h1>
            ...
            <div class="content-sections">
                <section id="home-section" class="content-section active">
                    <form id="share-boost-form" class="space-y-5 mt-3" method="GET">
                       <div>
                            ...
                            <input type="text" id="search" name="search" class="w-full p-3 rounded-lg border bg-input-bg border-input-border text-text-main placeholder-text-muted focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all text-sm" placeholder="Type Here..." required>
                        </div>
                                                                        <button type="submit" id="submit-button" class="w-full bg-primary text-white py-3 rounded-lg font-semibold text-base hover:bg-primary-darker transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed shadow-md hover:shadow-lg shadow-primary/30 active:scale-[0.98] mt-1">
                                    ...
                                    <div class="card">
                                        <form action="" method="post">
                                            <div class="component_form_group">
                                                <div class="form-group">
                                                                         <div class="flex items-start gap-3 p-2">
                                                                                                     <i data-lucide="<?php echo htmlspecialchars($row['icon_class']); ?>" class="w-5 h-5 text-primary flex-shrink-0 mt-0.5"></i>
                                                    <h4 class="text-lg text-info-text"><?php echo htmlspecialchars($row['title']); ?></h4>
                                                    </div>
                                            ...
                                            <div class="component_button_submit">
                                                <div class="form-group">
                                                    <a class="w-full bg-primary text-white py-3 rounded-lg font-semibold text-base hover:bg-primary-darker transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed shadow-md hover:shadow-lg shadow-primary/30 active:scale-[0.98] mt-2" href="<?php echo htmlspecialchars($row['link']); ?>" class="btn btn-block btn-big-primary">
                                                        <i class="fa <?php echo htmlspecialchars($row['icon_class']); ?>"></i> Go
                                                    </a>
                                                </div>
                                            </div>
                                        </form>
                ...
                <section id="services-section" class="content-section">
                    ...
                    <div id="services-list" class="space-y-4">
                        <div class="mt-2">
                        <div class="bg-gradient-to-br from-slate-800/90 to-slate-700/80 rounded-xl border border-green-500/50 shadow-lg p-6 flex flex-col text-center transition-all duration-300 ease-out hover:shadow-green-500/30 hover:scale-[1.03] hover:border-green-400 backdrop-blur-sm">
    <div class="mb-3">
        <div class="inline-flex items-center justify-center w-12 h-12 bg-green-500/20 rounded-full mb-3">
            <i data-lucide="pencil-line" class="w-6 h-6 text-green-400"></i>
        </div>
        <h3 class="text-xl font-semibold text-green-400 mb-1">Writing Services</h3>
        <p class="text-xs text-green-300 uppercase tracking-wider font-medium">Wide Range</p>
    </div>
                        <p class="text-3xl font-bold text-text-main mb-4">₱50 - ₱500</p>
                        <ul class="text-sm text-text-muted space-y-2 text-left mb-6 flex-grow">
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Written Essays</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Write Ups</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Summarizing</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Proofreading</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Editorial Writing</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Technical Writing</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Movie Review</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Book Review</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Reflection Paper</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Position Paper</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Reaction Paper</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Poems</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Speeches</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Argumentative Paper</li>
                            <li class="flex items-center gap-2"><i data-lucide="check" class="w-4 h-4 text-green-400"></i> Term Paper</li>
                        </ul>
<a href="https://www.facebook.com/share/14JneaKF36E/" target="_blank"
   class="plan-request-button w-full mt-auto bg-green-600 hover:bg-green-700 border-green-500 flex items-center justify-center gap-2 text-white px-4 py-2 rounded">
   <i data-lucide="send" class="w-4 h-4"></i> Request Service
</a>
                    </div>
    ...
    <div class="p-3 bg-bg-card rounded-xl border border-border-color shadow-card overflow-hidden">
        <?php if ($user): ?>                  
            <form id="profile-settings-form" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="profile-fullname" name="fullname" required
                        class="w-full p-3 rounded-lg border bg-input-bg border-input-border text-text-main focus:outline-none focus:border-primary text-sm"
                        value="<?php echo htmlspecialchars($user['fullname'] ?? 'N/A'); ?>">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="profile-username" name="username" required
                        class="w-full p-3 rounded-lg border bg-input-bg border-input-border text-text-main focus:outline-none focus:border-primary text-sm"
                        value="<?php echo htmlspecialchars($user['username'] ?? 'N/A'); ?>">
                    <p class="text-xs text-amber-400 mt-1">
                        Changing username might affect logins if saved elsewhere. Requires re-login.
                    </p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="email" id="profile-email" name="email" required
                        class="w-full p-3 rounded-lg border bg-input-bg border-input-border text-text-main focus:outline-none focus:border-primary text-sm"
                        value="<?php echo htmlspecialchars($user['email'] ?? 'N/A'); ?>">
                </div>

                <button type="submit" id="update-profile-button"
                    class="w-full bg-primary text-white py-3 rounded-lg font-semibold text-base hover:bg-primary-darker shadow-md hover:shadow-lg active:scale-[0.98] transform transition-all duration-200 hover:-translate-y-1">
                    <span class="button-text">Update Profile</span>
                </button>
            </form>

            <div class="settings-divider my-6 border-t border-border-color"></div>
            ...
            <form id="change-password-form" method="POST">
                ...
                <div class="mb-4">
                    <label for="profile-new-password">New Password (min 6 chars)</label>
                ...
                <div class="mb-6">
                    ...
                    <input type="password" id="profile-confirm-new-password" name="confirmNewPassword" required autocomplete="new-password"
                        class="w-full p-3 rounded-lg border bg-input-bg border-input-border text-text-main focus:outline-none focus:border-primary text-sm">
                </div>
                                ...
                                <div class="flex items-start gap-3 p-3.5 bg-info-bg rounded-lg border border-info-border shadow-sm mb-3">
                                    <div class="card">
                                        <form action="" method="post">
                                            <div class="component_form_group">
                                                <div class="form-group">                                                 
                                                    <p class="text-sm text-info-text"><?php echo htmlspecialchars($rows['content']); ?></p>
                                             </div>
                                            </div>
                                        </form>
                                    </div>
            ...
            <div class="relative">
                <div class="flex justify-around items-center px-3 py-2.5">
                    ...
                    <a href="#" data-section="services" class="nav-item flex flex-col items-center text-text-muted p-2 w-1/3 hover:text-primary transition-colors">
                        <i data-lucide="briefcase" class="w-5 h-5 mb-0.5"></i><span class="text-xs font-medium">Services</span>
                    <a href="#" data-section="tutorial" class="nav-item flex flex-col items-center text-text-muted p-2 w-1/3 hover:text-primary transition-colors">
                        <i data-lucide="user-cog" class="w-5 h-5 mb-0.5"></i><span class="text-xs font-medium">Profile</span>
                    </a>
    ...
    <script>
        ...
        const serverDefinitions = {
            server1: { name: "Server 1", url: 'https://share-5kpv.onrender.com' },
